...
//             SELECT BACK COURSE    
            ...
            if(Front===0 && Back===1) {FrontBack=0;
               else if(Front===1 && Back===0) {FrontBack=1;
                  else if(Front===2 && Back===1) {FrontBack=0;
                     else if(Front===1 && Back===2) {FrontBack=1;
                        else if(Front===0 && Back===2) {FrontBack=0;
                           else if(Front===2 && Back===0) {FrontBack=1;}}}}}}
